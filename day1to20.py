...
# listquestion = ["What is your name?", "How old are you?", "What is your favorite color?"]
# correctanswers = ["noman","20","blue"]
# inputanswers = []
# for question in listquestion:
#     answer = input(question + " ")
#     inputanswers.append(answer.lower())

# if inputanswers == correctanswers:
#     print("All answers are correct!")
# else:
#     print("Some answers are incorrect.")
# print("Your answers:", inputanswers)
